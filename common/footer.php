<footer class="page-footer teal darken-4" style="padding-top: 0">
  <div class="row" style="margin: 0">
    <div class="col l3 m6 s12" id="align">
    ...
    <div class="col l3 m6 s12 center">
      <h5>Contato:</h5>
      <a class="white-text normal-text" href="mailto:eeepjalbano@gmail.com">
        <sub><sub><i class="material-icons" style="position: relative;top: 50%;">email</i></sub></sub>
        eeepjalbano@gmail.com
      </a><br>
      <a class="white-text" href="tel:08531012072"><sub><sub><i class="material-icons">phone</i></sub></sub> (85) 3101-2072</a><br>
    ...
    <div class="col l3 m6 s12 center hide-on-small-only" style="padding: 0;display: flex;">
      <iframe style="position: relative; right: 0; width: 100%; height: 100%;top: 0px; border: 0;" src="https:/www.google.com/maps/embed?pb=!1m14!1m8!1m3!1d15925.115504220736!2d-38.5099877!3d-3.7493274!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x0%3A0x7eb2e63b55439b21!2sEEEP%20Professor%20Joaquim%20Ant%C3%B4nio%20Albano!5e0!3m2!1spt-BR!2sbr!4v1610156891468!5m2!1spt-BR!2sbr " frameborder="0" allowfullscreen="" aria-hidden="false" tabindex="0"></iframe>
    </div>
    <div class="col l3 m6 s12 hide-on-med-and-up center">
      <!-- Modal Trigger -->
      <a class="btn-floating btn-large waves-effect waves-light orange darken-3 modal-trigger" href="#modal">
        <i class="material-icons">location_on</i>
      </a>
      <!-- Modal Structure -->
      <div id="modal" class="modal">
        <div id="mapa" class="modal-content">
          <!-- Mapa -->
          <iframe style="position: relative; width: 100%; height: 100%; border:0;" src="https:/www.google.com/maps/embed?pb=!1m14!1m8!1m3!1d15925.115504220736!2d-38.5099877!3d-3.7493274!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x0%3A0x7eb2e63b55439b21!2sEEEP%20Professor%20Joaquim%20Ant%C3%B4nio%20Albano!5e0!3m2!1spt-BR!2sbr!4v1610156891468!5m2!1spt-BR!2sbr" frameborder="0" allowfullscreen="" aria-hidden="false" tabindex="0"></iframe>
        </div>

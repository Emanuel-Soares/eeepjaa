...
<body>
  ...
  <main>
      ...
      <div class="row grey lighten-4 center-align">
        <div class="col s12">
          <ul class="tabs grey lighten-4">
            ...
            <li class="tab col s2 m4"><a href="#prof" class="teal-text">Professores</a></li>
        ...
        <div class="col s6 m4">
          <div class="card hoverable">
            ...
            <div class="card-content">
              ...
              <p class="teal-text">Professora da Base Técnica</p>
            </div>
            <div class="card-reveal">
              <span class="card-title grey-text text-darken-4">Formação A.<i class="material-icons right">close</i></span>
              <p>Graduada em Enfermagem.</p>
        ...
        <div class="col s6 m4">
          <div class="card hoverable">
            ...
            <div class="card-content">
              ...
              <p class="teal-text">Professor da Base Técnica</p>
            </div>
            <div class="card-reveal">
              <span class="card-title grey-text text-darken-4">Formação A.<i class="material-icons right">close</i></span>
    ...
    <div id="test-swipe-6" class="col s8">
